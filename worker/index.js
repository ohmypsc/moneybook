    ...
    try {
      ...
      if (url.pathname.startsWith("/api/")) {
        ...
        if (request.method === "GET" && url.pathname === "/api/dashboard") {
          const data = await appsScriptGet(env, "dashboard", {
        ...
        if (
          ...
          const data = await appsScriptGet(env, "investmentAccounts");
          return jsonResponse(data);
        }
        ...
        if (
          ...
          const data = await appsScriptGet(env, "holdings", {
            accountId: url.searchParams.get("accountId") || "",
        ...
        if (
          ...
          const data = await appsScriptGet(env, "investmentTrades", {
            accountId: url.searchParams.get("accountId") || "",
            holdingId: url.searchParams.get("holdingId") || "",
            tradeType: url.searchParams.get("tradeType") || "",
            includeDeleted: url.searchParams.get("includeDeleted") || ""
          });
          return jsonResponse(data);
        }
        ...
        if (
          ...
          const data = await appsScriptGet(env, "investmentCash", {
            accountId: url.searchParams.get("accountId") || ""
          });
          return jsonResponse(data);
        }
        ...
        if (
          ...
          const data = await appsScriptPost(env, "createInvestmentTrade", {
            ...body,
            actor: session.name
          });
        ...
        if (
          ...
          const data = await appsScriptPost(env, "updateInvestmentTrade", {
            ...body,
            actor: session.name
          });
        ...
        if (
          ...
          const data = await appsScriptPost(env, "deleteInvestmentTrade", {
            ...body,
            actor: session.name
          });
        ...
        if (
          ...
          const data = await appsScriptPost(env, "restoreInvestmentTrade", {
            ...body,
            actor: session.name
          });
